  ...
  questions = [
      ...
      [
        {
          text = ''
            ...
            instruction? How many references are needed for each type of
            instruction to bring an operand in to a process register?
          '';
          marks = 5;
        }
      ]
    ...
    [
      [
        {
          text = ''
            A digital common bus system for 16 registers of 32 bits each. The
    ...
    [
      [
        {
          text = ''
            Simplify the following Boolean function in sum-of-products form by
            means of a four-variable map. Draw the logic diagram with:
              1. AND-OR gate
              2. NAND gates
